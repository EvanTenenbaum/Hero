...
describe('Sprint 28: Features & Polish', () => {
  ...
  describe('28.1 LLM Streaming', () => {
    ...
    it('should have streaming router', () => {
      const routerContent = fs.readFileSync('/home/user/Hero/server/routers/chat-stream.ts', 'utf-8');
    ...
    it('should have streaming state in Chat page', () => {
      const chatContent = fs.readFileSync('/home/user/Hero/client/src/pages/Chat.tsx', 'utf-8');
  ...
  describe('28.2 Command Palette', () => {
    it('should have CommandPalette component', () => {
      const exists = fs.existsSync('/home/user/Hero/client/src/components/CommandPalette.tsx');
      expect(exists).toBe(true);
    });

    it('should have keyboard shortcut hook', () => {
      const paletteContent = fs.readFileSync('/home/user/Hero/client/src/components/CommandPalette.tsx', 'utf-8');
    ...
    it('should be integrated in App.tsx', () => {
      const appContent = fs.readFileSync('/home/user/Hero/client/src/App.tsx', 'utf-8');
